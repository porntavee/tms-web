...
export class EmployeeDialog {
  ...
  read() {
    ...
    else if (this.criteriaModel.Code != undefined && this.criteriaModel.Code != '')
...
@Component({
  selector: 'financial-project-dialog',
  templateUrl: 'financial-project-dialog.html',
})
export class FinancialProjectDialog {
  constructor(
    public dialogRef: MatDialogRef<FinancialProjectDialog>,
    @Inject(MAT_DIALOG_DATA) public data: any) { }
  ...
  read() {
    ...
    if ((this.criteriaModel.Code != undefined && this.criteriaModel.Code != '') && (this.criteriaModel.Name != undefined && this.criteriaModel.Name != ''))
      this.data.listData = this.data.listDataSearch.filter(c => c.PrjCode.includes(this.criteriaModel.Code) && c.PrjName.includes(this.criteriaModel.Name));
    else if (this.criteriaModel.Code != undefined && this.criteriaModel.Code != '')
      this.data.listData = this.data.listDataSearch.filter(c => c.PrjCode.includes(this.criteriaModel.Code));
    else if (this.criteriaModel.Name != undefined && this.criteriaModel.Name != '')
      this.data.listData = this.data.listDataSearch.filter(c => c.PrjName.includes(this.criteriaModel.Name));
    else
      this.data.listData = this.data.listDataSearch
  }
...
export class StageDialog {
  ...
  read() {
    ...
    // if ((this.criteriaModel.Code != undefined && this.criteriaModel.Code != '') && (this.criteriaModel.Name != undefined && this.criteriaModel.Name != ''))
    //   this.data.listData = this.data.listDataSearch.filter(c => c.PrjCode.includes(this.criteriaModel.Code) && c.PrjName.includes(this.criteriaModel.Name));
    if (this.criteriaModel.U_HMC_Stage != undefined && this.criteriaModel.U_HMC_Stage != '')
      this.data.listData = this.data.listDataSearch.filter(c => c.U_HMC_Stage.includes(this.criteriaModel.U_HMC_Stage));
    // else if (this.criteriaModel.Name != undefined && this.criteriaModel.Name != '')
    //   this.data.listData = this.data.listDataSearch.filter(c => c.PrjName.includes(this.criteriaModel.Name));
    else
      this.data.listData = this.data.listDataSearch
...
@Component({
  selector: 'doc-log-dialog',
  templateUrl: 'doc-log-dialog.html',
})
export class DocLogDialog {
  constructor(
    public dialogRef: MatDialogRef<DocLogDialog>,
    @Inject(MAT_DIALOG_DATA) public data: any) { }
